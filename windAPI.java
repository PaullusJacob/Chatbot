...
public class windAPI
{
    ...
    static String startWebRequest(String city){
        ...
        try {
            ...
            String testString = (": Wind gust is currently: " + windGust + " mph" );
    ...
    static String parseJson(String json) {
        ...
        JsonPrimitive latitude = currentObject.getAsJsonPrimitive("wind_gust_mph"); // gets wind gust


        return latitude.getAsString();
    }
}
